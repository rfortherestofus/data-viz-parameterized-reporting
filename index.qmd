...
- If you're interested in parameterized reporting, chat with Jadey
:::
...
median_income <- read_csv("data/median_income.csv") |>
  ...
  filter(year == 2024) |> 
  select(geography, amount, amount_formatted)
...
pre_post_data <-
  ...
  mutate(
    ...
    growth_formatted = if_else(timing == "Post", growth_formatted, NA),
...
1. Packages are helpers, but you are the one who has to do the thinking
