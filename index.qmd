...
```{r}
penguins_scatterplot(number_of_dots = 10)
```
...
```{r}
penguins_scatterplot(number_of_dots = 100) +
  geom_text_repel(aes(label = island))
```
...
## TODO: add country map with just outline before showing shadow
